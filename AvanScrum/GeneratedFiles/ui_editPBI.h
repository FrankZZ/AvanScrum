...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        listWidget->setGeometry(QRect(10, 100, 151, 411));
        listWidget_2 = new QListWidget(Dialog);
        listWidget_2->setObjectName(QStringLiteral("listWidget_2"));
        listWidget_2->setGeometry(QRect(250, 100, 151, 411));
        pushButton = new QPushButton(Dialog);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(180, 200, 45, 41));
        ...
        lbl_ExcludedSbisTitel = new QLabel(Dialog);
        lbl_ExcludedSbisTitel->setObjectName(QStringLiteral("lbl_ExcludedSbisTitel"));
        lbl_ExcludedSbisTitel->setGeometry(QRect(250, 70, 151, 21));
        lbl_ExcludedSbisTitel->setFont(font1);
        pushButton_2 = new QPushButton(Dialog);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(180, 280, 45, 41));
        pushButton_2->setFont(font1);
        txt_Description = new QTextBrowser(Dialog);
        txt_Description->setObjectName(QStringLiteral("txt_Description"));
        txt_Description->setGeometry(QRect(450, 100, 431, 341));
        lbl_PbiDescription = new QLabel(Dialog);
        lbl_PbiDescription->setObjectName(QStringLiteral("lbl_PbiDescription"));
        lbl_PbiDescription->setGeometry(QRect(450, 70, 431, 21));
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        lbl_ExcludedSbisTitel->setText(QApplication::translate("Dialog", "andere SBI's", 0));
        pushButton_2->setText(QApplication::translate("Dialog", "<<", 0));
        lbl_PbiDescription->setText(QApplication::translate("Dialog", "andere SBI's", 0));
    } // retranslateUi
